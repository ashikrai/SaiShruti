package com.example.saishruti.Utils.constants;
...
//    Favourite Table Columns
    ...
    public final static String bhajanCreatedDate= "bhajanCreatedDate";
    ...
    public final static String deityOrder= "DeityOrder";
